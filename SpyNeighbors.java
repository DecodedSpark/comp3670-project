...
public class SpyNeighbors {
    //for running with PrintWriter
    SpyNeighbors(String seekerIp, PrintWriter pr) throws IOException {
        ...
        for (int i = 1; i < 255; i++) {
            ...
            if (InetAddress.getByName(hostIp).isReachable(5000)) {
                pr.println("IP Address " + hostIp + " is a live host on the same LAN as JobSeeker.");
            }
        }
    }
