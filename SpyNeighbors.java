...
public class SpyNeighbors {
    //for testing without PrintWriter
    public static void SpyNeighbors(String seekerIp, PrintStream output) throws IOException {
        ...
        for (int i = 1; i < 255; i++) {
            ...
            if (InetAddress.getByName(hostIp).isReachable(5000)) {
                ...
                output.println("IP Address " + hostIp + " is a live host on the same LAN as JobSeeker.");
            }
        }
    }
    ...
    public static void main (String[] args) throws Exception {
        ...
        PrintStream spyOutput = new PrintStream(new FileOutputStream("spyOutput.txt"));
        SpyNeighbors(testIp, spyOutput);//spy on neighbors
        //close file
        spyOutput.close();
    }
