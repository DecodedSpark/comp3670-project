    ...
    public static void main(String[] args) throws IOException {
        ...
        while (i < 3 && count < maxTries) {
            try {
                ...
                PrintStream output = new PrintStream(new FileOutputStream("outputJ6test.txt"));
                ...
                output.print("Job: ");
                jobType = "6";// jobType is 6 for test case of job 6
                ...
                if (!jobType.equalsIgnoreCase("3")) {
                    ...
                    ip = "0.0.0.0";// IP for test case is dummy IP 0.0.0.0
                    output.println(ip);
                }
                else {
                ...
                if (!jobType.equalsIgnoreCase("1") && !jobType.equalsIgnoreCase("3") && !jobType.equalsIgnoreCase("5")) {
                    ...
                    port = 53;// port for test case is 53
                    output.println(port);
                    pr.println(port);
                    pr.flush();
                }
