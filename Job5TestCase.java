    ...
    public static void main(String[] args) throws IOException {
        ...
        while (i < 3 && count < maxTries) {
            try {
                ...
                PrintStream output = new PrintStream(new FileOutputStream("outputJ5test.txt"));
                ...
                output.print("Job: ");
                jobType = "5";// jobType is 5 for test case of job 5
                ...
                if (!jobType.equalsIgnoreCase("3")) {
                    ...
                    ip = "www.twitter.com";// hostname for test case
                    output.println(ip);
                }
                else {
